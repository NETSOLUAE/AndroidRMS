...
import rms.netsol.com.rmsystem.View.Activity.Enquiry;
import rms.netsol.com.rmsystem.View.Activity.FeedBackForm;
import rms.netsol.com.rmsystem.View.Activity.HomeActivity;
import rms.netsol.com.rmsystem.View.Activity.HomeActivityLines;
import rms.netsol.com.rmsystem.View.Activity.HomeActivitySalaryDeduction;
import rms.netsol.com.rmsystem.View.Activity.LoginActivity;
...
import rms.netsol.com.rmsystem.View.Activity.PolicyDetailsActivity;
import rms.netsol.com.rmsystem.View.Activity.PostCommentActivity;
import rms.netsol.com.rmsystem.View.Activity.RegistrationActivity;
...
public class WebserviceManager {
        ...
        try {
            ...
            if (loginResp.has("data")) {
                ...
                if (type.equalsIgnoreCase("eb")) {
                    ...
                    masterData.setMobileNo(phoneNumber);
    ...
    public String policyDetailsCall (String actionID){
        String result = "";
        URL url = null;
        HttpURLConnection connection = null;
            ...
            if (status == HttpURLConnection.HTTP_OK) { //success
                ...
                if (!result.equalsIgnoreCase("")){
                    ...
                    String statusPolicy = policyResp
                            .getString("status");
                    String policyMessage = policyResp
                            .getString("message");
                    String policyData = policyResp
                            .getString("data");
                    PolicyDetailsActivity.message = policyMessage;
                    if (statusPolicy.equalsIgnoreCase("success")) {
                        result = parsePolicyDetails(policyData);
                    } else {
                        result = statusPolicy;
                    }
                } else {
    ...
    private String parsePolicyDetails(String response) {
        ...
        String deviceID =  Constants.deviceID;
        try {
            JSONObject policyResp = new JSONObject(response);
            String content = policyResp.getString("contents");
            PolicyDetailsActivity.htmlString = content;
            ...
            if (status == HttpURLConnection.HTTP_OK) { //success
                ...
                if (!result.equalsIgnoreCase("")){
                    ...
                    String feedbackComments = postCommentsResp
                            .getString("message");
                    FeedBackForm.message = feedbackComments;
                    Enquiry.message = feedbackComments;
                    result = statusPostComments;
                } else {
                    result = "NoData";
                }
    ...
    public String registration (String action_id, String name, String dob, String mobile, String companyName, String email, String nationalID, String password){
        String result = "";
        URL url = null;
        HttpURLConnection connection = null;
        ...
        try {
            POST_PARAMS = "action_id=" + action_id + "&full_name=" + name + "&date_of_birth=" + dob + "&mobile_no=" + mobile + "&company_name=" + companyName + "" +
                    "&email=" + email + "&national_id=" + nationalID + "&password=" + password;
