...
public class HomeActivityLines extends MyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_lines);

        context = HomeActivityLines.this;
        databaseManager = new DatabaseManager(this);
        _webserviceManager = new WebserviceManager(this);

        mHandler = new Handler();

        drawer = (DrawerLayout) findViewById(R.id.drawer_layout_lines);
        navigationView = (NavigationView) findViewById(R.id.nav_view_lines);

        // Setup Actionbar / Toolbar
        mToolbar = (Toolbar) findViewById(R.id.toolbar_lines);
        ...
        activityTitles = getResources().getStringArray(R.array.nav_item_activity_titles_lines);
        ...
        String changePin = databaseManager.getChangePinLines();
        if (changePin.equalsIgnoreCase("Yes")){
            showResetPin(isMandatory);
        }
        ressources = getResources();

        tabHost = (TabHost) findViewById(R.id.tabHostLines);
        ...
        Intent intentMemberDetails = new Intent(HomeActivityLines.this, PolicyDetailsLinesActivity.class);
        ...
        Intent intentAccountSummary = new Intent().setClass(this, AccountSummaryLinesActivity.class);
    ...
    private View prepareTabView(Context context, String text, Drawable drawable, boolean isSelected, View selectedView) {
        view = LayoutInflater.from(context).inflate(R.layout.tab_layout_lines, null);

        TextView tabLabel = (TextView) view.findViewById(R.id.tabLabelSalaryLines);
        ImageView tabImage = (ImageView) view.findViewById(R.id.tabImageSalaryLines);
        LinearLayout tabBackground = (LinearLayout) view.findViewById(R.id.tabBackgroundLayoutLines);
        ...
        if (selectedView == null){
            ...
            if (isSelected) {
                selectedView.findViewById(R.id.tabBackgroundLayoutLines).setBackgroundDrawable(ressources.getDrawable(R.drawable.tab_selected));
            }
            else {
                selectedView.findViewById(R.id.tabBackgroundLayoutLines).setBackgroundDrawable(ressources.getDrawable(R.drawable.tab_default));
            }
    ...
    private void loadNavHeader() {
        String name = databaseManager.getNameLines();
        String phone = databaseManager.getNationalIdLines();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_notifications_lines:
                        navItemIndex = 3;
                        CURRENT_TAG = TAG_NOTIFICATIONS;
                        drawer.closeDrawers();
                        break;
                    case R.id.nav_reset_pin_lines:
                        navItemIndex = 4;
                        CURRENT_TAG = TAG_RESET;
                        drawer.closeDrawers();
                        showResetPin(false);
                        break;
                    case R.id.nav_logout_lines:
    ...
    public void resetPIN(final String newPin) {
        try {
            _loginServiceCall = new AsyncServiceCall() {
                ...
                protected void onPreExecute() {
                    progressDialog = ProgressDialog.show(
                            HomeActivityLines.this,
                            HomeActivityLines.this.getResources().getString(
                ...
                protected Object doInBackground(Integer... params) {
                    String staffID = databaseManager.getStaffIdLines();
                    String clientID = databaseManager.getClientIdLines();
                    national_id=pref.getString("national_id_lines", null);
                    return _webserviceManager.loginAuthentication("reset_pin",national_id,newPin, Constants.deviceID.trim(), staffID, clientID, "lines");
                }
                ...
                protected void onPostExecute(Object resultObj) {
                    ...
                    if (result.equalsIgnoreCase("success") || result.equalsIgnoreCase("fail")) {
                        if (result.equalsIgnoreCase("success")) {
                            ...
                            Intent home = new Intent(HomeActivityLines.this, LoginActivity.class);
                            home.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                            home.putExtra("SELECTED_TAB", "personalLines");
                            startActivity(home);
                        } else {
                            Toast.makeText(getBaseContext(), memberMessage, Toast.LENGTH_LONG).show();
                            showResetPin(isMandatory);
            ...
            try {
                if (NetworkManager.isNetAvailable(HomeActivityLines.this)) {
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent login = new Intent(HomeActivityLines.this, LoginActivity.class);
...
//            dialogBuilder.setCancelable(false);
        ...
        dialogBuilder.setPositiveButton("RESET", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                sharedPinNational=pref.getString("pin_lines", null);
                national_id=pref.getString("national_id_lines", null);
