        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameFiled.length() <= 0 || subjectFiled.length() <= 0
                    ...
                    if (subjectFiled.length() <= 0) {
                        Toast.makeText(getBaseContext(), "Please Enter Subject", Toast.LENGTH_LONG).show();
                    }
                    if (mobileNoFiled.length() <= 0) {
                        Toast.makeText(getBaseContext(), "Please Enter Mobile Number", Toast.LENGTH_LONG).show();
                    }
                    if (commentsField.length() <= 0) {
                        Toast.makeText(getBaseContext(), "Please Enter Comments", Toast.LENGTH_LONG).show();
                    }
                } else {
