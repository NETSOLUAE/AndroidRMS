...
//    public static String htmlString = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgetVertical = (LinearLayout) findViewById(R.id.forgetVertical);
            ...
            public void onClick(View v) {
                ...
                if (selectedMenu.equalsIgnoreCase("MemberDetails")) {
                    if (!textPassword.equalsIgnoreCase("")) {
                        ...
                        new AlertDialog.Builder(context)
                                .setTitle("Alert")
                                .setMessage("Please Enter your Mobile Number/Email.")
                                .setNeutralButton(
                                        "Ok",
                                        new DialogInterface.OnClickListener() {
                                            @Override
        ...
        if (selectedMenu.equalsIgnoreCase("MemberDetails")) {
            mobileHeading.setText("Mobile Number/Email");
            password.setInputType(InputType.TYPE_CLASS_TEXT);
            pinLayout.setVisibility(View.GONE);
            passwordText.setVisibility(View.VISIBLE);
            forgetPin.setVisibility(View.GONE);
            forgetPassword.setVisibility(View.VISIBLE);
            forgetVertical.setVisibility(View.VISIBLE);
...
//                password.setFocusable(false);
            ...
            forgetVertical.setVisibility(View.GONE);
                ...
                if (textPassword.length() != 0) {
                    if (selectedMenu.equalsIgnoreCase("MemberDetails")) {
                        if (passwordText.getText().toString().length() > 5 ){
                            ...
                            new AlertDialog.Builder(context)
                                    .setTitle("Alert")
                                    .setMessage(context.getString(R.string.password_error_message))
                                    .setNeutralButton(
                                            "Ok",
                                            new DialogInterface.OnClickListener() {
                                                @Override
            ...
            AsyncServiceCall _resetPinCall = new AsyncServiceCall() {
                ...
                protected Object doInBackground(Integer... params) {
                    if (type.equalsIgnoreCase("eb")) {
                        ...
                        return _webServiceManager.sms("reset_pin_new", textPassword, staffID, clientID, nationalID1, type);
//                        if (phoneNumber.equalsIgnoreCase("")) {
//                            return _webServiceManager.sms("reset_pin_new", textPassword, staffID, clientID, nationalID1, type);
//                        } else {
...
//                        }
                        ...
                        return _webServiceManager.sms("send_sms", textPassword, staffIDSalary, clientIDSalary, "", type);
//                        if (nationalID.equalsIgnoreCase("")) {
//                            return _webServiceManager.sms("send_sms", textPassword, staffIDSalary, clientIDSalary, "", type);
//                        } else {
...
//                        }
                        ...
                        return _webServiceManager.sms("send_sms", textPassword, staffIDLines, clientIDLines, "", type);
//                        if (nationalIDLines.equalsIgnoreCase("")) {
//                            return _webServiceManager.sms("send_sms", textPassword, staffIDLines, clientIDLines, "", type);
//                        } else {
...
//                        }
                        ...
                        staffID = _dbManager.getStaffId();
                        clientID = _dbManager.getClientId();
                        return _webServiceManager.sms("reset_pin_new", textPassword, staffID, clientID, nationalID1, "eb");
                    }
                }
        ...
        try {
            AsyncServiceCall _memberServiceCall = new AsyncServiceCall() {
                ...
                protected Object doInBackground(Integer... params) {
                    staffID = _dbManager.getStaffId();
                    clientID = _dbManager.getClientId();
                    String mobileNo = pref.getString("phone_number", "");
                    return _webServiceManager.memberDetailsCall("staff_details", mobileNo, staffID, clientID);
                }
    ...
    private void policyDetailsCall() {
        try {
            AsyncServiceCall _policyDetailsCall = new AsyncServiceCall() {
                ...
                protected Object doInBackground(Integer... params) {
                    String mobileNo = pref.getString("phone_number", "");
                    return _webServiceManager.policyDetailsCall("staff_policy_summary", mobileNo, staffID, clientID);
                }
